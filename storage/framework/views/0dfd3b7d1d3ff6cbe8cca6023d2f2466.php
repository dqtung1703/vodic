...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - VODIC</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.posts.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.posts.*') ? 'active' : ''); ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="admin-header-content">
                ...
                <div class="header-actions">
                    <span style="color: #64748b; font-size: 0.9375rem;">
                        Xin chào, <strong style="color: #1e293b;"><?php echo e(auth()->user()->name); ?></strong>
                    </span>
                </div>
            </div>
        </header>
...
<?php /**PATH D:\2251172552_Tung\vodic\resources\views/admin/admin.blade.php ENDPATH**/ ?>