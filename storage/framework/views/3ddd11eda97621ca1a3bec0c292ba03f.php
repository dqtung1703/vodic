...
<div class="admin-card">
    <div class="card-header">
        ...
        <a href="<?php echo e(route('admin.categories.create')); ?>" class="btn-admin btn-primary-admin">
    ...
    <div style="overflow-x: auto;">
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <span style="font-weight: 700; color: #64748b;">#<?php echo e($category->id); ?></span>
                    </td>
                    <td>
                        <div>
                    ...
                    <td>
                        <div class="action-buttons" style="justify-content: center;">
                            <a href="<?php echo e(route('admin.categories.edit', $category)); ?>" class="action-btn action-edit">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <form action="<?php echo e(route('admin.categories.destroy', $category)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('Bạn có chắc muốn xóa danh mục này?')">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\2251172552_Tung\vodic\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>