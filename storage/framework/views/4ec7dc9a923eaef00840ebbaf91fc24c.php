...
<?php $__env->startSection('title', 'Giới thiệu - VODIC'); ?>
...
<section style="padding: 4rem 1.5rem; background: var(--gray-50);">
    <div class="container" style="max-width: 1200px; margin: 0 auto;">
        ...
        <div style="background: linear-gradient(135deg, rgba(0,102,204,0.05), rgba(0,61,130,0.05)); border-radius: 16px; padding: 3rem; text-align: center; border: 2px solid rgba(0,102,204,0.1);">
            ...
            <a href="<?php echo e(route('contact')); ?>" class="btn btn-primary" style="background: linear-gradient(135deg, var(--ocean-blue), var(--ocean-dark)); color: white; padding: 1rem 2.5rem; font-size: 1.125rem;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\2251172552_Tung\vodic\resources\views/pages/about.blade.php ENDPATH**/ ?>