    ...
    <div class="header-top">
        <div class="header-container">
            ...
            <a href="<?php echo e(route('home')); ?>" class="logo-wrapper">
                <img src="<?php echo e(asset('images/vodic_ico.gif')); ?>" alt="VODIC Logo" class="noaa-logo" style="max-width: 70px;">
                <div class="logo-text">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="user-dropdown">
                        ...
                        <div class="user-dropdown-menu">
                            ...
                            <?php if(!auth()->user()->isAdmin()): ?>
                                <a href="<?php echo e(route('user.posts.index')); ?>" class="dropdown-item">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<div class="mobile-menu" id="mobileMenu">
    <div class="mobile-menu-content">
        ...
        <nav class="mobile-nav">
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(auth()->user()->isAdmin()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" style="color: var(--gov-red);">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: inline-block; vertical-align: middle; margin-right: 0.5rem;">
...
</script><?php /**PATH D:\2251172552_Tung\vodic\resources\views/partials/header.blade.php ENDPATH**/ ?>