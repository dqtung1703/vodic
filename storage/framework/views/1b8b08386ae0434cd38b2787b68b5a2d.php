...
<div id="registerModal" class="modal-overlay" style="display: none;">
    <div class="modal-container">
        <div class="modal-content">
            ...
            <!-- Modal Body -->
            <form method="POST" action="<?php echo e(route('register')); ?>" class="modal-form">
                <?php echo csrf_field(); ?>
...
<?php if($errors->any() && request()->routeIs('register')): ?>
...
<?php /**PATH D:\2251172552_Tung\vodic\resources\views/partials/register-modal.blade.php ENDPATH**/ ?>