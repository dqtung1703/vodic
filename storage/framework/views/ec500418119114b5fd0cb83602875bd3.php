...
<div id="loginModal" class="modal-overlay" style="display: none;">
    <div class="modal-container">
        <div class="modal-content">
            ...
            <!-- Modal Body -->
            <form method="POST" action="<?php echo e(route('login')); ?>" class="modal-form">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Google Login Button -->
                <a href="<?php echo e(route('auth.google')); ?>" class="btn btn-google btn-block" style="background: white; color: #1e293b; border: 2px solid #e2e8f0; display: flex; align-items: center; justify-content: center; gap: 0.75rem; text-decoration: none; transition: all 0.3s;">
...
<?php /**PATH D:\2251172552_Tung\vodic\resources\views/partials/login-modal.blade.php ENDPATH**/ ?>