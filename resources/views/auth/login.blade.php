    ...
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('login') }}" id="loginForm">
            ...
            <div style="text-align: right; margin-bottom: 1.25rem;">
                <a href="{{ route('password.request') }}" style="color: #0066cc; text-decoration: none; font-size: 0.875rem; font-weight: 500; transition: color 0.3s;">
                    Quên mật khẩu?
                </a>
            </div>
