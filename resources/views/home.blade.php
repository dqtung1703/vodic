    ...
    <div class="container">
        ...
        <div class="news-layout">
            ...
            <aside class="news-sidebar">
                ...
                @if(isset($importantPosts) && $importantPosts->count() > 0)
                <div class="important-widget">
                    ...
                    @foreach($importantPosts as $index => $important)
                    <div class="important-item">
                        <div class="important-number">{{ $index + 1 }}</div>
                        <div class="important-content">
                            <div class="important-title">
                                <a href="{{ route('news.show', $important->slug) }}">
                                    {{ $important->title }}
                                </a>
                            </div>
                            <div class="important-meta">
                                <span class="important-category">{{ $important->category->name }}</span>
                                <span class="important-date">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <circle cx="12" cy="12" r="10"/>
                                        <polyline points="12 6 12 12 16 14"/>
                                    </svg>
                                    {{ $important->published_at->format('d/m/Y') }}
                                </span>
                            </div>
                        </div>
                    </div>
