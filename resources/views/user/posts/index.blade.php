...
<div class="container" style="padding: 3rem 1.5rem; max-width: 1200px;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        ...
        <a href="{{ route('user.posts.create') }}" style="background: var(--ocean-blue); color: white; padding: 0.75rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem;">
                    ...
                    <tr style="border-top: 1px solid #e5e7eb;">
                        <td style="padding: 1rem;">
                            <div style="display: flex; align-items: center; gap: 1rem;">
                                ...
                                @endif
                                <div>
                                    <strong style="color: var(--text-primary); display: block; margin-bottom: 0.25rem;">{{ $post->title }}</strong>
                                    <span style="color: var(--text-secondary); font-size: 0.875rem;">{{ Str::limit($post->excerpt, 60) }}</span>
                                </div>
                            </div>
                        </td>
                        <td style="padding: 1rem;">
                        ...
                        <td style="padding: 1rem;">
                            <strong style="color: var(--ocean-blue);">{{ number_format($post->views) }}</strong>
                        </td>
                        ...
                        <td style="padding: 1rem;">
                            <div style="display: flex; gap: 0.5rem;">
                                ...
                                @if($post->status === 'draft')
                                    ...
                                    <form action="{{ route('user.posts.destroy', $post) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
    ...
    @else
        <div style="background: white; border-radius: 12px; padding: 4rem 2rem; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            ...
            <a href="{{ route('user.posts.create') }}" style="background: var(--ocean-blue); color: white; padding: 0.875rem 2rem; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem;">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <line x1="12" y1="5" x2="12" y2="19"></line>
                    <line x1="5" y1="12" x2="19" y2="12"></line>
                </svg>
