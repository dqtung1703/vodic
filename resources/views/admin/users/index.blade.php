...
<div class="admin-card">
    <div class="card-header">
        ...
        <a href="{{ route('admin.users.create') }}" class="btn-primary-admin" style="text-decoration: none !important; border-bottom: none !important; box-shadow: 0 2px 8px rgba(0, 102, 204, 0.3) !important; outline: none !important;">
    ...
    <div style="padding: 1.5rem 2rem;">
        ...
        <form method="GET" class="filters-container">
            ...
            @if(request()->hasAny(['search', 'status', 'role']))
                <a href="{{ route('admin.users.index') }}" class="btn-admin btn-secondary-admin">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
